...
window = Tk()
window.title("Engineering Calculator by Tarak")
window.geometry("383x635+470+20")
...
label = Label(window, text="Developed by Tarak Rahman", font=("Calibri", 12), foreground="white", background="gray11")
label.grid(row=10, column=0, columnspan=4, pady=5)
mainloop()